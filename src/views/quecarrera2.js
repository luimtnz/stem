...
import im1 from '../quecarre/1.png';
import im2 from '../quecarre/2.png';
import im3 from '../quecarre/3.png';
import im4 from '../quecarre/4.png';

const IMAGES = [im1,im2,im3,im4]

const alfabeto =['A','B','C','D','E','F','G','I','J','L','M','N','O','P','R','S','T','U','V',' ']
...
const preguntas =[
  ...
  {
    respuesta: 'ASTRONOMIA'
  }
]


class quecarrera2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
